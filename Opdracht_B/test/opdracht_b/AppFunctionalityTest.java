...
import opdracht_b.pojo.KlantWithAnnotations;
...
//    
//    @Test
//    public void testbuildInsertStatementForAnnotatedObject() {
//        System.out.println("Build insert statement for Annotated Object:");
//        KlantWithAnnotations klantje = new KlantWithAnnotations();
//        klantje.setVoornaam("Pieter");
//        klantje.setAchternaam("Boer");
//        klantje.setTussenvoegsel("de");
//        klantje.setEmail("pieterboer@gmail.com");
//        klantje.setStraatnaam("Straatnaam");
//        klantje.setPostcode("4534DF");
//        klantje.setToevoeging("C");
//        klantje.setHuisnummer(65);
//        klantje.setWoonplaats("Leiden");
//     
//            String buildstmt = functions.buildInsertStatementForAnnotatedObject(klantje);
//            System.out.println(buildstmt);
//
//    }
//
//    @Test
//    public void testEntityAnnotationNotFound() {
//        expectedEx.expect(Exception.class);
//        expectedEx.expectMessage("Object is not annotated with @Entity");
//
//        String buildstmt = functions.buildInsertStatementForAnnotatedObject(klant);
//
//    }
